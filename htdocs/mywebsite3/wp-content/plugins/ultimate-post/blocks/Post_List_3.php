...
class Post_List_3{
    ...
    public function get_attributes($default = false) {
        ...
        $attributes = array(
            ...
            'catSacing' => [  
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => 0, 'bottom' => 10,'left' => 0,'right' => 0, 'unit' =>'px'], 'xs' =>(object)['top' => 15, 'bottom' => 0, 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'catShow','condition'=>'==','value'=>true],
            ...
            'readMoreSacing' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => 20,'bottom' => '','left' => '','right' => '', 'unit' =>'px'], 'xs' =>(object)['top' => 15,'bottom' => '','left' => '','right' => '', 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'readMore','condition'=>'==','value'=>true],
            ...
            'metaMargin' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => '15','bottom' => '15', 'left'=>'','right'=>'', 'unit' =>'px'], 'xs' =>(object)['top' => '10','bottom' => '10', 'left'=>'','right'=>'', 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'metaShow','condition'=>'==','value'=>true],
            ...
            'counterTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography' => 1, 'size' => (object)['lg' => 18, 'unit' =>'px'], 'height' => (object)['lg' =>'', 'unit' =>'px'], 'spacing' => (object)['lg' =>0, 'unit' =>'px'], 'transform' => '', 'weight' => '400', 'decoration' => 'none','family'=>'' ],
                'style' => [
                    (object)[
                        'depends' => [
            ...
            'imgSpacing' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-block-item .ultp-block-image { margin-right: {{imgSpacing}}px; margin-left: {{imgSpacing}}px; } .rtl {{ULTP}} .ultp-block-item .ultp-block-image { margin-right: 0; margin-left: {{imgSpacing}}px; }'
                    ],
                    (object)[
                        'depends' => [
                            (object)['key'=>'showImage','condition'=>'==','value'=>true],
                            (object)['key'=>'imgFlip','condition'=>'==','value'=>false],
                            (object)['key'=>'layout','condition'=>'==','value'=> 'layout5'],
                        ],
                        'selector'=>'{{ULTP}} .ultp-block-item .ultp-block-image { margin-right: {{imgSpacing}}px; margin-left: {{imgSpacing}}px; } .rtl {{ULTP}} .ultp-block-item .ultp-block-image { margin-right: 0; margin-left: {{imgSpacing}}px; }'
                    ],
                    (object)[
            ...
            'mobileImageTop' => [
                ...
                'style' => [
                    (object)[
                        'selector'=>'@media (max-width: 768px) {{{ULTP}} .ultp-block-item .ultp-block-image {margin-right:0; margin-left:0; max-width: 100%; } {{ULTP}} .ultp-block-media .ultp-block-content-wrap { display: block;} {{ULTP}} .ultp-block-media .ultp-block-content-wrap .ultp-block-content {margin: auto 0px !important; padding: 0px }}'
                    ]
                ],
            ],
            'imgOverlay' => [
