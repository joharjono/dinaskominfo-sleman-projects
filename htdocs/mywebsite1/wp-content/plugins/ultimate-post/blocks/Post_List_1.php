...
class Post_List_1{
    ...
    public function get_attributes($default = false) {
        ...
        $attributes = array(
            ...
            'columnGridGap' => [
                'type' => 'object',
                'default' => (object)['lg' =>'30', 'xs' => '16', 'unit' =>'px'],
                'style' => [
                    (object)[
            ...
            'postListTypo' => [ // small title
                'type' => 'object',
                'default' =>  (object)['openTypography' => 1,'size' => (object)['lg' => '28', 'unit' => 'px'], 'height' => (object)['lg' => '36', 'unit' => 'px'],'decoration' => 'none', 'transform' => '', 'family'=>'','weight'=>'500'],
                'style' => [(object)[
                    'depends' => [
                        (object)['key'=>'titleShow','condition'=>'==','value'=>true],
                        (object)['key'=>'gridStyle','condition'=>'!=','value'=>"style1"],
            ...
            'titlePadding' => [
                'type' => 'object',
                'default' => (object)['lg'=>(object)['top'=> '10', 'unit'=>'px'], 'xs'=>(object)['top'=> '0', 'unit'=>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
            ...
            'metaMargin' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => '15','bottom' => '15', 'left'=>'','right'=>'', 'unit' =>'px'], 'xs' =>(object)['top' => '10', 'bottom' => '10', 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'metaShow','condition'=>'==','value'=>true],
            ...
            'catSacing' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['bottom' => '', 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'catShow','condition'=>'==','value'=>true],
            ...
            'imgWidth' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-block-item .ultp-block-image { max-width: {{imgWidth}}; display: block;}  {{ULTP}} .ultp-block-item .ultp-block-image img { width: 100% }'
                    ],
                ],
            ],
            'imgHeight' => [
            ...
            'contentWrapShadow' => [
                'type' => 'object',
                'default' => (object)['openShadow' => 1, 'width' => (object)['top' => 0, 'right' => 0, 'bottom' => 20, 'left' => 0],'color' => 'rgba(0, 0, 0, 0.06)'],
                'style' => [
                    (object)[
                        'selector'=>'{{ULTP}} .ultp-block-content-wrap'
                    ],
            ...
            'contentWrapInnerPadding' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => '30','bottom' => '40', 'left'=>'30','right'=>'30', 'unit' =>'px'], 'xs' =>(object)['top' => '16','bottom' => '16', 'left'=>'16','right'=>'16', 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
            ...
            'headerWidth' => [
                'type' => 'object',
                'default' => (object)['lg' =>'70', 'xs' =>'85', 'unit' =>'%'],
                'style' => [
                    (object)[
                        'depends' => [ 
                            (object)['key'=>'layout','condition'=>'!=','value'=>'layout1'],
            ...
            'headerSpaceY' => [
                ...
                'style' => [
                    ...
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-block-item:first-child .ultp-block-entry-heading { bottom: -{{headerSpaceY}}px; }
                        {{ULTP}} .ultp-block-item:first-child .ultp-block-content { padding-top: {{headerSpaceY}}px !important; } {{ULTP}} .ultp-block-item:not(:first-child) .ultp-block-entry-heading { top: -{{headerSpaceY}}px; }
                        {{ULTP}} .ultp-block-item:not(:first-child) { margin-top: {{headerSpaceY}}px !important; }',
                    ]
                ],
            ],
            'headerWrapPadding' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => '20','bottom' => '20', 'left'=>'20','right'=>'24', 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [ 
                            (object)['key'=>'layout','condition'=>'!=','value'=>'layout1'],
            ...
            'excerptPadding' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => '20','bottom' => '', 'unit' =>'px'], 'xs' =>(object)['top' => '14','bottom' => '', 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'excerptShow','condition'=>'==','value'=>true],
            ...
            'excerptPadddingLg' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-block-item:first-child .ultp-block-excerpt { padding: {{excerptPadddingLg}}; }'
                    ],
                ],
            ],
            'responsiveExcerpt' => [
            ...
            'readMoreSacing' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => 20, 'bottom' => '','left' => '','right' => '', 'unit' =>'px'], 'xs' =>(object)[ 'top' => 10, 'bottom' => 0, 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'readMore','condition'=>'==','value'=>true],
