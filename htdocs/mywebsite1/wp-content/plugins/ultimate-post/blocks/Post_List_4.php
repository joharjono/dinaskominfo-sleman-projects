...
class Post_List_4{
    ...
    public function get_attributes($default = false) {
        ...
        $attributes = array(
            ...
            'spaceLargeItem' => [
                'type' => 'object',
                'default' => (object)['lg' =>'60', 'xs' =>'40', 'unit' =>'px'],
                'style' => [
                    (object)[
            ...
            'titleLgTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'28', 'unit'=>'px'], 'spacing'=>(object)[ 'lg'=>'', 'unit'=>'px'], 'height'=>(object)[ 'lg'=>'36', 'unit'=>'px'],'decoration'=>'none','transform' => '','family'=>'','weight'=>'500'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
            ...
            'titleTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'20', 'unit'=>'px'], 'spacing'=>(object)[ 'lg'=>'0', 'unit'=>'px'], 'height'=>(object)['lg'=>'28', 'unit'=>'px'],'transform' => '', 'decoration'=>'none','family'=>'','weight'=>'500'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
            ...
            'titlePadding' => [
                'type' => 'object',
                'default' => (object)['lg'=>(object)['top'=>0,'bottom'=> 15, 'unit'=>'px'], 'xs'=>(object)['top'=>0,'bottom'=> 10, 'unit'=>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
            ...
            'excerptLimitLg' => [
                ...
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'showFullExcerptLg','condition'=>'==','value'=> false],
                        ],
                    ],
                ],
            ],
                ...
                'style' => [
                    (object)[
                        'depends' => [
                            ...
                            (object)['key'=>'showSmallExcerpt','condition'=>'==','value'=> true],
                        ],
                    ],
                ],
            ],
            ...
            'excerptPadding' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => 15,'bottom' => 0, 'unit' =>'px'], 'xs' =>(object)['top' => 5]],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'excerptShow','condition'=>'==','value'=>true],
            ...
            'counterTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography' => 1, 'size' => (object)['lg' =>18, 'unit' =>'px'], 'height' => (object)['lg' =>'30', 'unit' =>'px'], 'spacing' => (object)['lg' =>0, 'unit' =>'px'], 'transform' => '', 'weight' => '400', 'decoration' => 'none','family'=>'' ],
                'style' => [
                    (object)[
                        'depends' => [
            ...
            'catSacing' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => '','bottom' => '10','left' => 0,'right' => 0, 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'catShow','condition'=>'==','value'=>true],
            ...
            'metaTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography' => 1,'size' => (object)['lg' =>12, 'unit' =>'px'],'height' => (object)['lg' =>20, 'unit' =>'px'], 'decoration' => 'none', 'transform' => 'capitalize','family'=>''],
                'style' => [
                    (object)[
                        'depends' => [
            ...
            'readMoreTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography' => 1, 'size' => (object)['lg' =>12, 'unit' =>'px'], 'height' => (object)['lg' =>'25', 'unit' =>'px'], 'spacing' => (object)['lg' => '', 'unit' =>'px'], 'transform' => 'uppercase', 'weight' => '500', 'decoration' => 'underline','family'=>'' ],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'readMore','condition'=>'==','value'=>true],
