    ...
    public static function tab_page_content() {
        ...
        if ($current) {
            ...
            echo '<div class="ultp-settings-tab-wrap">';
                ...
                if (date('U') < strtotime('18-2-2023') && !$pro_active) {
                    echo '<div class="ultp-setting-hellobar"><span class="dashicons dashicons-bell ultp-ring"></span><strong> Offer: </strong> Enjoy a flat <b>30% off</b> with the coupon code <b>POSTX30K</b> to celebrate our 30,000+ active installs! - <a href="'.esc_url(ultimate_post()->get_premium_link( '', 'menu_topbar')).'" target="_blank">'.esc_html__('Grab Your Discount Now!', 'ultimate-post').'</a></div>';
                } else {
                    if (!$pro_active) {
